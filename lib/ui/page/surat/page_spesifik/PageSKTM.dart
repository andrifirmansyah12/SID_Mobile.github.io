...
class _SKTMState extends State<SKTM> {
  ...
  TextEditingController _text3 = new TextEditingController(text: "NIK : ");
  TextEditingController _text4 = new TextEditingController(text: "Agama : ");
  TextEditingController _text5 = new TextEditingController(text: "Status : ");
  TextEditingController _text6 =
      new TextEditingController(text: "Pekerjaan : ");
  TextEditingController _text7 = new TextEditingController(text: "Alamat : ");
  TextEditingController _text8 =
      new TextEditingController(text: "Jenis Kelamin : ");
  TextEditingController _text9 =
      new TextEditingController(text: "Rumah Keluarga : ");
              ...
              children: <Widget>[
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "contoh : ISLAM/HINDU/KRISTEN/BUDHA",
                      style: TextStyle(color: Colors.black),
                    ),
                  ],
                ),
