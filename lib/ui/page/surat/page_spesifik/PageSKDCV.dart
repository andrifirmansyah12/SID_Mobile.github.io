...
class SKDCV extends StatefulWidget {
  @override
  _SKDCVState createState() => _SKDCVState();
}

class _SKDCVState extends State<SKDCV> {
  ...
  TextEditingController _text1 = new TextEditingController(text: "Nama CV : ");
  TextEditingController _text2 =
      new TextEditingController(text: "Nama Direktur : ");
  TextEditingController _text3 = new TextEditingController(text: "Alamat : ");
  TextEditingController _text4 = new TextEditingController(text: "Desa : ");
  TextEditingController _text5 =
      new TextEditingController(text: "Kecamatan : ");
  TextEditingController _text6 =
      new TextEditingController(text: "Kabupaten : ");
  TextEditingController _text7 = new TextEditingController(text: "Provinsi : ");
  ...
  Future save() async {
    if (code.toString() == _capthaController.text) {
      final response = await http
        ...
        "nama_surat": "Surat Keterangan Domisili CV",
        "status": "Terkirim",
